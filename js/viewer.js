...
function StudentManager() {
	...
	*/
	this.addStudentsFromData = function(data) {};
            /* for loop that runs through all the data blocks in the array,
            *  and uses addNewStudent to build the student objects,
               and pushes them to this.students */
	...
	*/
	this.addNewStudent = function(data) {};
            /* for loop that runs through the inside of each data block,
             * and formats the student objects to be useed by Student later on */
};
